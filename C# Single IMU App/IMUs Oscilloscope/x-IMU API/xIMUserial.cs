...
namespace x_IMU_API
{
    ...
    public class xIMUserial
    {
        ...
        public xIMUserial()
        {
            ...
            csvfileWriter = new x_IMU_API.CSVfileWriter(@".\File.csv");
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="xIMUserial"/> class.
        /// </summary>
            ...
            for (int i = 0; i < numBytesRead; i++)
            {
                ...
                if ((serialBuffer[i] & 0x80) == 0x80)                               // if new byte was packet framing char 
                {
                    ...
                    try
                    {
                        ...
                        dataObject = PacketConstruction.DeconstructPacket(encodedPacket);//解码
                    }
                    catch
                    {
                    ...
                    {                    
                        ...
                        else if (dataObject is CalInertialAndMagneticData)
                        {
                            OnCalInertialAndMagneticDataReceived((CalInertialAndMagneticData)dataObject);
                        ...
                        //csvfileWriter.WriteData(dataObject);
                    }
        ...
        public event onCalInertialAndMagneticDataReceived CalInertialAndMagneticDataReceived;//拿哪种委托类型作为事件的约束，以及对事件处理器的应用。
